...
function Career() {
  ...
  const jobDetails = [
    ...
    },
    {
      ...
      description:
        "В свободное от учёбы время и от личных проектов занимаюсь дизайном сайтов и Frontend разработкой. Я всегда открыт к новым проектам и предложениям. Если у вас есть интересный проект, который вы хотите реализовать, напишите мне на почту или в телеграм и Мы все обусудим👇🏻",
      image: "/freelance.png",
      projects: [
        {
          name: "Сайт школы программирования IT-Park",
